...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    login(email || "usuario@radaropme.com.br", password);
    navigate("/dashboard");
  };
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6 relative">
      ...
      >
        ...
        <p className="text-muted-foreground mb-8 text-center text-sm">
          Acesse sua plataforma de inteligência OPME-DMI
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className="h-11 rounded-lg pl-10 bg-secondary border-border focus:border-accent"
              />
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <a href="#" className="text-xs text-accent hover:text-accent-hover">Esqueceu a senha?</a>
            </div>
            <div className="relative">
              <Input
                id="password"
